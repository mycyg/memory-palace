...
Local checks passed: **381 Python tests** (three optional legacy real-model tests deselected), **136 DeepSeek Harness tests**, **3 TypeScript SDK tests**, and **5 browser workflows**. The separate configured-model replay above exercises real model requests.
